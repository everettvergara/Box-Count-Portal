...
use App\Http\Requests\tb_bc_tr_box_count_image_request;
use App\Models\tb_bc_tr_box_count_image;
use Illuminate\Http\Request;

class tb_bc_tr_box_count_image_controller extends Controller
{
    protected $route;
    protected $route_var;
    ...
    {
        $this->route = 'box-count-images';
        $this->route_var = 'box_count_image';
        $this->header_route = 'box-counts';
        $this->header_route_var = 'box_count';
        $this->title = 'Box Count Images';
        $this->view_path = 'tb_bc_tr_box_count_image';
        $this->pk_var = 'box_count_id';
        $this->pk_val = 'box_count';
    }
    ...
    public function store(tb_bc_tr_box_count_image_request $r)
    {
    ...
    {
        $datum = tb_bc_tr_box_count_image::findOrFail($id);
    ...
    public function update(tb_bc_tr_box_count_image_request $r, $id)
    {
        $datum = tb_bc_tr_box_count_image::findOrFail($id);
        $validatedData = $r->validated();
        $datum->fill($validatedData);
