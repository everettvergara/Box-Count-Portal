@forelse ($data as $datum)
    <tr>
        ...
        <td>{{ $datum->warehouse_portal }}</td>
        <td>{{ $datum->trans_id }}</td>
        <td>{{ $datum->customer }}</td>
        <td>{{ $datum->doc_type }}</td>
        <td>{{ $datum->doc_no }}</td>
        <td>{{ $datum->doc_date }}</td>
        <td>{{ $datum->box_count }}</td>
        <td>{{ $datum->reject_conveyor_count }}</td>
        <td>{{ $datum->reject_truck_count }}</td>
